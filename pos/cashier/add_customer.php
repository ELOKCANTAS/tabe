...
if (isset($_POST['addCustomer'])) {
  ...
  if (empty($_POST["NomorTelepon"]) || empty($_POST["NamaPelanggan"]) || empty($_POST['Alamat'])) {
    ...
    $postQuery = "INSERT INTO pelanggan (PelangganID, NamaPelanggan, NomorTelepon, Alamat) VALUES(?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);
    
    //bind paramaters
    $rc = $postStmt->bind_param('ssss', $PelangganID, $NamaPelanggan, $NomorTelepon, $Alamat);
    $postStmt->execute();
              ...
              <form method="POST">
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <input type="hidden" name="PelangganID" value="<?php echo $PelangganID; ?>" class="form-control">
                  </div>
                  <div class="col-md-6">
