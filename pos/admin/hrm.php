...
if (isset($_GET['delete'])) {
  ...
  $adn = "DELETE FROM  user  WHERE  UserID = ?";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM  user WHERE level='petugas' ";
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $staff->NamaLengkap; ?></td>
                      <td><?php echo $staff->Email; ?></td>
                      <td><?php echo $staff->Alamat; ?></td>
                      <td>
                        <a href="hrm.php?delete=<?php echo $staff->UserID; ?>">
                        ...
                        <a href="update_staff.php?update=<?php echo $staff->UserID; ?>">
